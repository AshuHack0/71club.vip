 ...
 #qrCodeImage
    ...
    <div class="weui-media-box weui-media-box_text" style="padding-top:10px">
        <div id="qrcodeImg" style="text-align: center;">
            <img style="height:200px; width:200px;" src="https://71club.vip/qr.png" id="qrCodeImage">
        </div>
        
        <!-- Download Button -->
        <div style="text-align:center; margin-top:10px;">
            <a href="https://71club.vip/qr.png" download="QRCodeImage" class="weui-btn weui-btn_primary" style="background-color: #487ef5; color: white; border: 1px solid #487ef5;">Download QR CODE</a>
        </div>
        ...
        <div style="display:flex;justify-content:space-between;align-items:center;border:1px solid #BDBDBD!important;padding:4px;border-radius:6px; margin-top:10px;">
            <span class="weui-media-box__title" id="upi" style="color:#333;font-weight:500;margin:0px !important;text-shadow:1px 1px 0 #fff;background-color: #e0e73a4f;text-align:center;padding:10px 0;letter-spacing:1px;">8809890011@okbizaxis</span>
