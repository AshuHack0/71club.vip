<?php 
    ...
    $cooming_soon = genPath('/updates/coming-soon');
    ...
    if ($_SERVER['REQUEST_METHOD'] != 'GET') {
        if (
            ...
            $deviceType = htmlspecialchars(mysqli_real_escape_string($conn, $shonupost['deviceType']));

            $shonustr = '{"gameCode":"' . $gameCode . '","language":' . $language . ',"deviceType":' . $deviceType . ',"random":"' . $random . ',"vendorCode":' . $vendorCode . '}';
