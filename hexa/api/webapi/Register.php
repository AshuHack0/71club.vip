...
if ($_SERVER['REQUEST_METHOD'] != 'GET') {
    if (isset($shonupost['domainurl']) && isset($shonupost['invitecode']) && isset($shonupost['language']) && isset($shonupost['phonetype']) && isset($shonupost['pwd']) && isset($shonupost['random']) && isset($shonupost['registerType']) && isset($shonupost['timestamp']) && isset($shonupost['username'])) {
        ...
        if($samasyephalitansa_dhadi == 1){
            ...
            if($samasyephalitansa_dhadi == 0){
                ...
                $tathya = mysqli_query($conn,"INSERT INTO `shonu_kaichila` (`balakedara`,`motta`,`bonus`,`dinankavannuracisi`) VALUES ('".$last_id."','','','".$shnunc."')");
