                ...
                if($sesnum == 1){
                    ...
                    if ($payid == 2) {
                        $data["rechargetypelist"][] = [
                            ...
                            "miniPrice" => 100,
                            "maxPrice" => 50000,
                            "scope" => "100|500|1000|5000|10000|500000",
                            "paySendUrl" => $sites."/pay/cola",
                            "parameters" => '',
                            "startTime" => "00:00",
                            "endTime" => "24:00",
                            "rechargeRifts" => 0.00,
                        ...
                        $data["rechargetypelist"][] = [
                            ...
                            "miniPrice" => 10,
                            "maxPrice" => 50000,
                            "scope" => "500|1000|2500|5000|10000",
                            "paySendUrl" => $sites."/pay/usdt",
                            "parameters" => '',
                            "startTime" => "01:00",
                            "endTime" => "23:00",
                            "rechargeRifts" => 0.02,
