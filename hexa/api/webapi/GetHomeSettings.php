...
if ($_SERVER['REQUEST_METHOD'] != 'GET') {
	if (isset($shonupost['language']) && isset($shonupost['random']) && isset($shonupost['signature']) && isset($shonupost['timestamp'])) {
		...
		if ($shonusign == $signature) {
			...
			$data['projectName'] = '71Club';
			$data['projectLogo'] = 'https://71club.vip/assets/logo.png';
			$data['languages'] = 'en|hd|ta|te';
			$data['webIco'] = 'https://71club.vip/assets/fav.png';
			$data['headLogo'] = 'https://71club.vip/assets/wlogo.png';
			$data['dollarSign'] = '₹';
			$data['upperOrLower'] = '0';
