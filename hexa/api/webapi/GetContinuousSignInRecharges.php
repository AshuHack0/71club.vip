			...
			if($shonusign == $signature){
				...
				if($data_auth['status'] === 'Success') {
					...
					if($sesnum == 1){
						...
						$data['signInRechargesList'][0]['bouns'] = 5;
						...
						$data['signInRechargesList'][1]['bouns'] = 10;
						...
						$data['signInRechargesList'][2]['bouns'] = 50;
						...
						$data['signInRechargesList'][4]['bouns'] = 350;
						...
						$data['signInRechargesList'][5]['bouns'] = 3000;
						...
						$data['signInRechargesList'][6]['bouns'] = 5000;
